...
export const skills: Skill[] = [
  ...
  },
  {
    ...
    level: "professional",
    experienceIds: ["katalyst-data-engineer-intern"],
    evidenceNote: "Query engine with Reflections optimization, API automation, v25 evaluation.",
  },
  {
    id: "pgvector",
    name: "pgvector",
    ...
    level: "professional",
    experienceIds: ["quanskill-data-engineer-intern"],
    evidenceNote: "Vector embeddings storage for RAG pipelines.",
  },
  {
    id: "streamlit",
    name: "Streamlit",
    ...
    level: "professional",
    experienceIds: ["quanskill-data-engineer-intern"],
    evidenceNote: "Interactive dashboards for data product interfaces.",
  },
  {
    id: "github-actions",
    name: "GitHub Actions",
    ...
    level: "professional",
    experienceIds: ["quanskill-data-engineer-intern"],
    evidenceNote: "CI/CD pipelines for automated testing and deployment.",
  },
  {
    ...
    level: "professional",
    experienceIds: ["katalyst-data-engineer-intern"],
    evidenceNote: "Row-level data access controls in Dremio for governance.",
  },
  {
    id: "column-masking",
    name: "Column Masking",
    ...
    level: "professional",
    experienceIds: ["katalyst-data-engineer-intern"],
    evidenceNote: "Column-level data masking for sensitive field protection.",
  },
];
